...
##### The prompts are meant to create a plan for a project by taking the goal, 
task that need to be done, the amount of people they have to work on in, and when it needs to get done.

# #Prompt
##### A team of [GROUP_AMOUNT], whose roles are [TEAM_ROLES] needs to complete a project that’s goal is [GOAL]. 
